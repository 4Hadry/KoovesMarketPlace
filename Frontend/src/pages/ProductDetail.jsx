    ...
    <div>
      <div class="font-sans bg-white">
        <div class="p-6 lg:max-w-7xl max-w-4xl mx-auto">
          <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 rounded-xl">
          ...
          {/* <div class="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
            ...
            <ul class="mt-6 space-y-6 text-[#333]">
              ...
              <li class="text-sm">
                DISPLAY RESOLUTION{" "}
                <span class="ml-4 float-right">2880x1620</span>
              </li>
            </ul>
          </div> */}

          <div class="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 rounded-xl">
